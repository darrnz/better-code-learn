...
// ------------------
// What is an Array?
// - An array is a simple data structure that stores elements in a fixed, ordered list.
// - Each element can be accessed directly by its index (position).
...
// Summary:
// - Arrays are great for storing ordered data and accessing items by position.
// - Use arrays for lists, sequences, and any situation where order and index matter.
